...
I am a **Computer Engineering** student specializing in local-first AI architectures, agentic pipelines, and real-time AI at the edge. I have a strong passion for designing privacy-preserving, high-performance systems and robust backend architectures.

Currently, I am developing advanced AI-based apps, custom edge intelligence pipelines on **NVIDIA Jetson Orin** platforms, and fine-tuning deep learning models for domain-specific NLP applications. 
